...
export function generateInvoicePdf(invoice, options = {}) {
  ...
  currentPage.push(textLine("Thanking You", contentLeft, 106, 9, "F2"));
  currentPage.push(rightText(`For ${invoice.companyDetails.companyName}`, 385, 164, 150, 9, "F2"));
  if (hasSignature) {
    currentPage.push("q 92 0 0 34 426 122 cm /Sig Do Q");
  }
  currentPage.push(rightText("Proprietor", 410, 108, 100, 9, "F2"));
  linesByPage.push(currentPage);
